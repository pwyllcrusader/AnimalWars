...
public class WarService {
	...
	public void beginTournament(List<Animal> fighters) {
		...
		TournamentHelper.saveFightResult("First fight: " + fighters.get(0).getName() + " versus " + fighters.get(1).getName() + "\n" +
										"The first semifinalist is " + semifinalist1.getName() + "!\n");
		Animal semifinalist2 = fight(fighters.get(2), fighters.get(3));
		TournamentHelper.saveFightResult("Second fight: " + fighters.get(2).getName() + " versus " + fighters.get(3).getName() + "\n" +
				"The second semifinalist is " + semifinalist2.getName() + "!\n");
		Animal champion = fight(semifinalist1, semifinalist2);
		TournamentHelper.saveFightResult("Final fight: " + fighters.get(2).getName() + " versus " + fighters.get(3).getName() + "\n" +
